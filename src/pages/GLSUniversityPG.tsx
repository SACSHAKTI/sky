...
import { MapPin, Clock, Star, ArrowRight, CheckCircle, BookOpen, Users } from 'lucide-react';
...
const GLSUniversityPG = () => {
  ...
  useMetaTags({
    title: 'Best PG near GLS University Ahmedabad | Student Accommodation Navrangpura',
    description: 'Premium PG near GLS University, Navrangpura, Ahmedabad. Just 5 minutes walk to campus. Perfect for Law, Management, and Engineering students. AC rooms, food, Wi-Fi, and study areas. Book your PG near GLS University today!',
    image: 'https://lovable.dev/opengraph-image-p98pqg.png',
    url: 'https://theskyliving.co.in/student-accommodation-gls-university',
    canonical: 'https://theskyliving.co.in/student-accommodation-gls-university'
  });

  const businessData = {
    name: 'The Sky Living near GLS University',
    description: 'Premium student accommodation just 5 minutes walk from GLS University, Navrangpura. Perfect for Law, Management, and Engineering students with modern amenities and academic-focused environment.',
    url: 'https://theskyliving.co.in/student-accommodation-gls-university',
    telephone: '+91-9876543210',
    email: 'info@theskyliving.co.in',
    address: {
      streetAddress: 'Chandra Colony, B/H IDBI Bank, Near Yes Bank, Opp. GLS University',
  ...
  useEffect(() => {
    const fetchNearbyAccommodations = async () => {
      try {
        ...
        console.error('Error fetching accommodations near GLS University:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  const universityAdvantages = [
    {
      title: "Law Students",
      description: "Perfect for GLS Law College students with quiet study spaces",
      icon: "⚖️"
    },
    {
      title: "Management Students",
      description: "Ideal for MBA and management program students",
      icon: "💼"
    },
    {
      title: "Engineering Students", 
      description: "Great for engineering and technical course students",
      icon: "🔧"
    },
    {
      title: "Walking Distance",
      description: "Just 5 minutes walk to GLS University campus",
      icon: "🚶"
    }
  ];

  const glsPrograms = [
    { faculty: "GLS Law College", programs: "LLB, LLM, BA LLB", duration: "3-5 Years" },
    { faculty: "GLS Institute of Business Administration", programs: "MBA, PGDM", duration: "2 Years" },
    { faculty: "GLS Institute of Computer Technology", programs: "BCA, MCA, MSc IT", duration: "3 Years" },
    { faculty: "GLS Institute of Engineering", programs: "BE, ME in various branches", duration: "4 Years" },
    { faculty: "GLS Institute of Management", programs: "BBA, MBA", duration: "3-2 Years" },
    { faculty: "GLS Institute of Pharmacy", programs: "B.Pharm, M.Pharm", duration: "4 Years" }
  ];

  const universityFeatures = [
    "5 minutes walk to GLS University",
    "Perfect for Law, Management, and Engineering students",
    "Near GLS Law College",
    "Close to GLS Business School",
    "Walking distance to university library",
    "Near student activity centers",
    "Close to university canteen",
    "Easy access to all GLS facilities"
  ];

  const studyBenefits = [
    "Quiet study environment for law students",
    "Group study areas for management students",
    "Technical discussion spaces for engineering students",
    "Library access within walking distance",
    "Academic calendar-aligned meal timings",
    "Exam-friendly policies and support",
    "Student community from same university",
    "Easy access to university events and seminars"
  ];
  ...
  const testimonials = [
    {
      ...
      text: "The Sky Living is perfect for law students. The quiet environment helps me focus on my studies, and the university is just a short walk away.",
      rating: 5
    },
    {
      name: "Riya Patel",
      course: "MBA Student",
      text: "Great place for management students! The location is excellent and the facilities are top-notch. Highly recommend for GLS students.",
      rating: 5
    },
    {
      name: "Harshil Shah",
      course: "BE Computer Engineering",
      text: "Living here has been fantastic. The technical discussions with fellow engineering students and the proximity to campus is unbeatable.",
      rating: 5
    }
  ];
  ...
  return (
    <div className="pt-20">
      ...
      {/* Hero Section */}
      <section className="relative py-24 bg-gradient-to-br from-blue-900 to-indigo-900 text-white">
        <div className="absolute inset-0 bg-black/30"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 font-heading">
              Best PG near <span className="text-yellow-400">GLS University</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-200">
              Just 5 minutes walk to campus • Perfect for Law, Management & Engineering students
            </p>
            <div className="flex items-center justify-center gap-6 mb-8">
              <div className="flex items-center">
                <Clock className="h-6 w-6 text-yellow-400 mr-2" />
                <span className="text-lg">5 min walk</span>
              </div>
              <div className="flex items-center">
                <Users className="h-6 w-6 text-yellow-400 mr-2" />
                <span className="text-lg">GLS Community</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-skyliving-700">
              Perfect for All GLS University Students
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {universityAdvantages.map((advantage, index) => (
      ...
      {/* GLS Programs Section */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-skyliving-700">
              GLS University Programs & Faculties
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {glsPrograms.map((program, index) => (
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-skyliving-700 text-sm">{program.faculty}</h3>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4 text-blue-700">
                Boys PG Properties near GLS University
              </h2>
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600 text-lg">No Boys PG properties (TSL 1, 2, 3) found near GLS University.</p>
                ...
                {boysPGAccommodations.map((accommodation) => (
                  <div key={accommodation.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border-l-4 border-blue-500">
                    <img 
                      ...
                      alt={`${accommodation.name} - Boys PG near GLS University`}
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <span className="text-sm text-gray-600">5 min walk to GLS University</span>
                      </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4 text-pink-700">
                Girls PG Properties near GLS University
              </h2>
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600 text-lg">No Girls PG properties (TSL 4, 5) found near GLS University.</p>
                <p className="text-gray-500 mt-2">Please check back later or contact us for more information.</p>
              </div>
            ) : (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {girlsPGAccommodations.map((accommodation) => (
                  <div key={accommodation.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow border-l-4 border-pink-500">
                    <img 
                      src={accommodation.main_image} 
                      alt={`${accommodation.name} - Girls PG near GLS University`}
                      className="w-full h-48 object-cover"
                    />
                    <div className="p-6">
                      <div className="flex items-center mb-2">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-skyliving-700">
              Study Benefits for GLS University Students
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-6 text-skyliving-700">Academic Support</h3>
                <ul className="space-y-3">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-skyliving-700">
              What GLS University Students Say
            </h2>
        ...
        pages={[
          {
            ...
            description: "Premium PG accommodation for St. Xavier's College students in Navrangpura.",
          ...
          },
          {
            ...
            description: "Modern accommodation for Nirma University students with tech-friendly facilities.",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">
              Ready to Live 5 Minutes from GLS University?
            </h2>
            <p className="text-xl mb-8 text-gray-200">
              Join GLS University students who have made The Sky Living their academic home
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold">
...
export default GLSUniversityPG;